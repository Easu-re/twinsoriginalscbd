  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <img src="/banner-tnc.png" style={{ width: "100%" }} />
          ...
          <Grid container justify="center">
            <Grid item xs={11} sm={10} md={9} lg={9} xl={9}>
              ...
              <Typography className={classes.detail}>
                ...
                (“you”) and Twins Originals LLC (“Company“, “we”, “us”, or
            ...
            <Grid item xs={11} sm={10} md={9} lg={9} xl={9}>
              ...
              <Typography className={classes.detail}>
                – Visa, discover, and master card. via NMI Merchant gateway.
              </Typography>
              <Typography className={classes.detail}>
                See NMI’s{" "}
                <a
                  style={{ color: "inherit" }}
                  href="https://www.nmi.com/privacy-policy"
                >
                  Privacy Policy
                </a>{" "}
                and{" "}
                <a
                  style={{ color: "inherit" }}
                  href="https://www.nmi.com/terms-and-conditions"
                >
            ...
            <Grid item xs={11} sm={10} md={9} lg={9} xl={9}>
              ...
              <Typography className={classes.detail}>
                Returns accepted within 14 days or order. Product must be
                unopened and unused.
              </Typography>
            </Grid>
            <Grid item xs={11} sm={10} md={9} lg={9} xl={9}>
            ...
            <Grid item xs={11} sm={10} md={9} lg={9} xl={9}>
              <Typography className={classes.subHeader}>SUBMISSIONS</Typography>
              <Typography className={classes.detail}>
            ...
            <Grid item xs={11} sm={10} md={9} lg={9} xl={9}>
              ...
              <Typography className={classes.detail}>
                ...
                <a
                  style={{ color: "inherit" }}
                  href="https://twinsoriginalscbd.com/wpautoterms/privacy-policy/"
                >
                  https://twinsoriginalscbd.com/wpautoterms/privacy-policy/
                </a>
            ...
            <Grid item xs={11} sm={10} md={9} lg={9} xl={9}>
              ...
              <Typography className={classes.detail}>
                ...
                laws of the State of Arizona applicable to agreements made and
                to be entirely performed within the State of Arizona, without
            ...
            <Grid item xs={11} sm={10} md={9} lg={9} xl={9}>
              <Typography className={classes.subHeader}>
                ...
                <Typography className={classes.detail}>
                  ...
                  determined to by the arbitrator to be excessive, we will pay
                  all arbitration fees and expenses. The arbitration may be
                  ...
                  will take place in United States, Arizona. Except as otherwise
                  ...
                  Terms of Use. In no event shall any Dispute brought by either
                  ...
                  personal jurisdiction of that court Restrictions
                </Typography>
                <Typography className={classes.detail}>
            ...
            <Grid item xs={11} sm={10} md={9} lg={9} xl={9}>
              <Typography className={classes.subHeader}>CORRECTIONS</Typography>
              <Typography className={classes.detail}>
            ...
            <Grid item xs={11} sm={10} md={9} lg={9} xl={9}>
              <Typography className={classes.subHeader}>DISCLAIMER</Typography>
              <Typography className={classes.detail}>
            ...
            <Grid item xs={11} sm={10} md={9} lg={9} xl={9}>
              ...
              <Typography className={classes.detail}>
                ...
                TO ANY CAUSE OF ACTION ARISING OR __________. CERTAIN STATE LAWS
            ...
            <Grid item xs={11} sm={10} md={9} lg={9} xl={9}>
              <Typography className={classes.subHeader}>USER DATA</Typography>
              <Typography className={classes.detail}>
            ...
            <Grid item xs={11} sm={10} md={9} lg={9} xl={9}>
              <Typography className={classes.subHeader}>CONTACT US</Typography>
              <Typography className={classes.detail}>
                In order to resolve a complaint regarding the Site or to receive
                further information regarding use of the Site, please contact us
                at:
                <Typography
                  style={{ fontSize: "0.9em", fontWeight: "900", color: 'white' }}
                >
                  <br /> Twins Originals LLC 4598 W 18th ln <br />
                  Yuma, AZ 85364
                  <br />
                  United States
                  <br />
